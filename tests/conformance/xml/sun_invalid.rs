...
fn invdtd01() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/dtd01.xml").unwrap());
...
fn invdtd02() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/dtd02.xml").unwrap());
...
fn invdtd03() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/dtd03.xml").unwrap());
...
fn el01() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/el01.xml").unwrap());
...
fn el02() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/el02.xml").unwrap());
...
fn el03() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/el03.xml").unwrap());
...
fn el04() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/el04.xml").unwrap());
...
fn el05() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/el05.xml").unwrap());
...
fn el06() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/el06.xml").unwrap());
...
fn id01() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/id01.xml").unwrap());
...
fn id02() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/id02.xml").unwrap());
...
fn id03() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/id03.xml").unwrap());
...
fn id04() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/id04.xml").unwrap());
...
fn id05() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/id05.xml").unwrap());
...
fn id06() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/id06.xml").unwrap());
...
fn id07() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/id07.xml").unwrap());
...
fn id08() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/id08.xml").unwrap());
...
fn id09() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/id09.xml").unwrap());
...
fn invnotsa01() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/not-sa01.xml").unwrap());
...
fn invnotsa02() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/not-sa02.xml").unwrap());
...
fn invnotsa04() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/not-sa04.xml").unwrap());
...
fn invnotsa05() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/not-sa05.xml").unwrap());
...
fn invnotsa06() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/not-sa06.xml").unwrap());
...
fn invnotsa07() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/not-sa07.xml").unwrap());
...
fn invnotsa08() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/not-sa08.xml").unwrap());
...
fn invnotsa09() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/not-sa09.xml").unwrap());
...
fn invnotsa10() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/not-sa10.xml").unwrap());
...
fn invnotsa11() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/not-sa11.xml").unwrap());
...
fn invnotsa12() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/not-sa12.xml").unwrap());
...
fn invnotsa13() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/not-sa13.xml").unwrap());
...
fn invnotsa14() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/not-sa14.xml").unwrap());
...
fn optional01() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/optional01.xml").unwrap());
...
fn optional02() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/optional02.xml").unwrap());
...
fn optional03() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/optional03.xml").unwrap());
...
fn optional04() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/optional04.xml").unwrap());
...
fn optional05() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/optional05.xml").unwrap());
...
fn optional06() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/optional06.xml").unwrap());
...
fn optional07() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/optional07.xml").unwrap());
...
fn optional08() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/optional08.xml").unwrap());
...
fn optional09() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/optional09.xml").unwrap());
...
fn optional10() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/optional10.xml").unwrap());
...
fn optional11() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/optional11.xml").unwrap());
...
fn optional12() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/optional12.xml").unwrap());
...
fn optional13() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/optional13.xml").unwrap());
...
fn optional14() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/optional14.xml").unwrap());
...
fn optional20() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/optional20.xml").unwrap());
...
fn optional21() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/optional21.xml").unwrap());
...
fn optional22() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/optional22.xml").unwrap());
...
fn optional23() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/optional23.xml").unwrap());
...
fn optional24() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/optional24.xml").unwrap());
...
fn optional25() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/optional25.xml").unwrap());
...
fn invrequired00() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/required00.xml").unwrap());
...
fn invrequired01() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/required01.xml").unwrap());
...
fn invrequired02() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/required02.xml").unwrap());
...
fn root() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/root.xml").unwrap());
...
fn attr01() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/attr01.xml").unwrap());
...
fn attr02() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/attr02.xml").unwrap());
...
fn attr03() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/attr03.xml").unwrap());
...
fn attr04() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/attr04.xml").unwrap());
...
fn attr05() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/attr05.xml").unwrap());
...
fn attr06() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/attr06.xml").unwrap());
...
fn attr07() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/attr07.xml").unwrap());
...
fn attr08() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/attr08.xml").unwrap());
...
fn attr09() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/attr09.xml").unwrap());
...
fn attr10() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/attr10.xml").unwrap());
...
fn attr11() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/attr11.xml").unwrap());
...
fn attr12() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/attr12.xml").unwrap());
...
fn attr13() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/attr13.xml").unwrap());
...
fn attr14() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/attr14.xml").unwrap());
...
fn attr15() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/attr15.xml").unwrap());
...
fn attr16() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/attr16.xml").unwrap());
...
fn utf16b() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/utf16b.xml").unwrap());
...
fn utf16l() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/utf16l.xml").unwrap());
...
fn empty() {
    ...
    */
    ...
    let testxml = parser::xml::parse(fs::read_to_string("tests/conformance/xml/xmlconf/sun/invalid/empty.xml").unwrap());
